...
import { LeftSidebarRail } from '../components/LeftSidebarRail';
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#131722] text-[#8b97a8] flex flex-row selection:bg-[#73e5bf] selection:text-[#131722]">
      {/* 1. Left Icon Sidebar Rail (Fixed/Sticky on Desktop) */}
      <LeftSidebarRail />

      {/* Main Content Area */}
      <div className="flex-1 flex flex-col min-w-0">
        {/* 2. Top 2 Navigation Bars (Main Header + Red Announcement Bar) */}
        <Navbar />
              ...
              <div className="pt-2 pb-2">
                <div className="max-w-xl mx-auto relative rounded-2xl bg-[#181e2b] border border-[#27c93f]/40 p-4 sm:p-4.5 text-left shadow-[0_0_20px_rgba(39,201,63,0.12)] hover:border-[#27c93f]/70 transition-all group">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    {/* Right CTA Button */}
                    <Link
                      href="/sponsor/20000000-0000-0000-0000-000000000001"
        ...
        {/* Minimal Footer */}
        <footer className="border-t border-[#212638] bg-[#11141e] text-[#8b97a8] py-8 text-xs">
