  ...
  return (
    <div className="min-h-screen bg-[#130f18] text-[#8b94a3] flex flex-col selection:bg-[#73e5bf] selection:text-[#130f18]">
      ...
      <main id="main-content" tabIndex={-1} className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 outline-none">
        ...
        <div className="mb-6 flex items-center gap-2 text-xs text-[#8b94a3]">
          ...
          <span className="text-[#8b94a3]/40">/</span>
          <span className="text-zinc-200 font-medium">Sponsor {slot.slot_name}</span>
        </div>

        {/* Listing & Slot Header Summary */}
        <div className="bg-[#21192a] rounded-[24px] border border-[#e5e7eb]/12 p-6 sm:p-8 mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-sm">
          <div>
            ...
            <p className="text-xs sm:text-sm text-[#8b94a3] max-w-2xl leading-relaxed">
          ...
          <div className="shrink-0 flex items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-[#e5e7eb]/12 bg-[#2e2d36] hover:bg-[#383742] text-xs font-semibold text-zinc-300 transition-colors"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#2e2d36] hover:bg-[#383742] text-xs font-semibold text-zinc-300 border border-[#e5e7eb]/10 transition-colors"
            >
